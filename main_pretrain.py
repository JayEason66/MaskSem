...
def get_args_parser():
    ...
    # Encoder parameters
    parser.add_argument('--encoder', default='mae_vit_large_patch16', type=str, metavar='MODEL',
                        help='Name of model to train')
    parser.add_argument('--encoder_args', default=dict(), help='the arguments of model')
...
def main(args):
    ...
    args.model_args['finetune'] = args.finetune
